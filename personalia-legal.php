...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'Aplikasi C-App/C-App2 (Ceklist Kendaraan Incoming) UNIMOS/MGFI'
        },
        subtitle: {
...
$(function () {
    $('#container2').highcharts({
        ...
        title: {
            text: 'Aplikasi IO-Goods (Android) Aplikasi Serah Terima Barang MGFI-Unimos'
        },
        subtitle: {
            text: 'Source: By E-Apps'
        },
...
<div class="text-center">  
   <!-- <img src="logo.png">-->
    <h4>Chart Tingkat Error dalam 30 hari terakhir (PERSONALIA LEGAL)</h4><br><br>
     <br>
      <div class="span5">
